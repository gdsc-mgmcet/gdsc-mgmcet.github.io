  ...
  return (
    <Container>
      <NavbarContainer>
        <Navbar>
          <LeftEnd>
            <SearchIcon data-scroll data-scroll-position="top" />
            <StyledTypeAnimation sequence={[SearchBarLine]} speed={20} wrapper="div" />
          </LeftEnd>
          <RightEnd data-scroll-section>
            <MicIconImg data-scroll data-scroll-position="top" />
            <CameraImg
